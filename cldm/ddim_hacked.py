...
class Control_Diff_VAE(torch.nn.Module):
    def __init__(self, control_model, diff_model, vae_model, 
                       steps, control_model_step_dict, diff_model_step_dict, 
                       alphas, alphas_prev, sqrt_one_minus_alphas, sigmas) -> None:
        super().__init__()
